...
export declare type ReferenceinfoOverridesProps = {
    Referenceinfo?: PrimitiveOverrideProps<ViewProps>;
...
export declare type ReferenceinfoProps = React.PropsWithChildren<Partial<ViewProps> & {
    overrides?: ReferenceinfoOverridesProps | undefined | null;
}>;
export default function Referenceinfo(props: ReferenceinfoProps): React.ReactElement;
