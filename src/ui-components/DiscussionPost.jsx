...
export default function DiscussionPost(props) {
  ...
  return (
    <Flex
      ...
      {...getOverrideProps(overrides, "DiscussionPost")}
      {...rest}
    >
      <Flex
        gap="40px"
        ...
        >
          ...
          >
            <View
              width="24px"
              height="24px"
              {...getOverrideProps(overrides, "MyIcon11175")}
            ></View>
            <Text
              fontFamily="Inter"
              fontSize="16px"
          ...
          >
            ...
            <View
              width="24px"
              height="24px"
              {...getOverrideProps(overrides, "MyIcon11179")}
            ></View>
            <View
              width="24px"
              height="24px"
              {...getOverrideProps(overrides, "MyIcon11180")}
            ></View>
            <View
              width="24px"
              height="24px"
              {...getOverrideProps(overrides, "MyIcon11181")}
            ></View>
          </Flex>
        </Flex>
      </Flex>
      <Flex
        ...
        position="relative"
        padding="0px 0px 0px 0px"
        {...getOverrideProps(overrides, "Read more11183")}
      >
        <View
          width="24px"
          height="24px"
          {...getOverrideProps(overrides, "MyIcon11184")}
        ></View>
        <Text
          fontFamily="Inter"
          fontSize="16px"
          ...
          whiteSpace="pre-wrap"
          children="Read more"
          {...getOverrideProps(overrides, "Read more11185")}
        ></Text>
      </Flex>
    </Flex>
  );
