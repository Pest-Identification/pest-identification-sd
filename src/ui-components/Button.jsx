...
export default function Button(props) {
  ...
  const variants = [
    {
      overrides: {
        "Button Icon111419": { width: "20px", height: "20px" },
        label: {
          fontSize: "20px",
        ...
        "Button Icon111421": { width: "20px", height: "20px" },
        Button: {
    ...
    {
      overrides: {
        "Button Icon111419": { width: "14px", height: "14px" },
        label: {
          fontSize: "14px",
          color: "rgba(255,255,255,1)",
          lineHeight: "21px",
        ...
        "Button Icon111421": { width: "14px", height: "14px" },
        Button: {
          border: "1px SOLID rgba(0,0,0,0)",
          borderRadius: "4px",
    ...
    {
      overrides: {
        "Button Icon111419": { width: "24px", height: "24px" },
        label: {
          fontSize: "14px",
          color: "rgba(92,102,112,1)",
          lineHeight: "21px",
        ...
        "Button Icon111421": { width: "24px", height: "24px" },
        Button: {
          borderRadius: "4px",
  ...
  return (
    ...
    >
      <View
        width="16px"
        height="16px"
        {...getOverrideProps(overrides, "Button Icon111419")}
      ></View>
      <Text
        fontFamily="Inter"
        fontSize="16px"
      ...
      <View
        width="16px"
        height="16px"
        {...getOverrideProps(overrides, "Button Icon111421")}
      ></View>
    </Flex>
  );
}
